...
% testEtabs = load('CB24F_etabs_beta0.7.txt');
testEtabs = load('CB24F_etabs_beta1.0.txt');
L = 36;
x = [-0.08 0.08];
% y = [-175 175];
y = [-800 800];
...
locsModelM = [locsS;locsMinM;length(testPartialM)];
