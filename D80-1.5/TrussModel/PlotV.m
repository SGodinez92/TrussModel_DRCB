...
testE = load('D80-1.5_partial.txt');
test = load('D80-1.5.txt');
% testEtabs = load('D80-1.5_etabs_beta0.7.txt');
testEtabs = load('D80-1.5_etabs_beta1.0.txt');
L = 27;
x = [-0.08 0.08];
% y = [-300 300];
y = [-1200 1200];
...
plt0 = plot(test(:,1),test(:,2)*4.4482,'.','MarkerSize',14,'color',[0.75 0.75 0.75]);
...
title('Energy Dissipated D80-1.5')
