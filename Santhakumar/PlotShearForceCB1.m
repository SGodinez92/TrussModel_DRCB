...
figure;
hold;
plt1 = plot(sStrainCB1,sForceCB1,'b','linewidth',1.3);
plt2 = plot(sStrainCB3,sForceCB3,'r','linewidth',1.3);
plt3 = plot(sStrainCB5,sForceCB5,'k','linewidth',1.3);
plt4 = plot(sStrainCB7,sForceCB7,'g','linewidth',1.3);
...
legend([plt1 plt5 plt6],'Aeq','Theoretical','ACI-318 limit','location','southeast');
